...
pub fn run() {
    ...
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            randomizer::commands::randomizer_dirs,
            randomizer::commands::set_randomizer_runtime_dir,
            randomizer::commands::set_randomizer_players_dir,
            randomizer::commands::open_randomizer_dir,
